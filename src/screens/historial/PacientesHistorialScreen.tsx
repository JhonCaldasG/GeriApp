...
type Props = NativeStackScreenProps<HistorialStackParamList, 'PacientesHistorial'>;

export default function PacientesHistorialScreen({ navigation }: Props) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <Text style={styles.instruccion}>Seleccione el paciente para ver o agregar registros médicos</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <PacienteCard
            paciente={item}
            onPress={() =>
              navigation.navigate('ListaHistorial', {
                pacienteId: item.id,

...
type Props = NativeStackScreenProps<ActividadesStackParamList, 'PacientesActividades'>;

export default function PacientesActividadesScreen({ navigation }: Props) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.instruccion}>Seleccione el paciente para ver o registrar actividades</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <PacienteCard
            paciente={item}
            onPress={() => navigation.navigate('ListaActividades', {
              pacienteId: item.id,
        ...
        ListEmptyComponent={
          <EmptyState
            ...
            subtitulo="Registre pacientes desde la sección Pacientes"
          />
        }
      />
    </View>
